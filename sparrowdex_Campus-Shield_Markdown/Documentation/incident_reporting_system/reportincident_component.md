...
<document-code-reference section="ReportIncident Component">
{"files": [
  {
...
The ReportIncident component is a crucial part of the Campus-Shield system, handling the submission of safety incident reports. It provides a multi-step form interface for users to input detailed information about campus safety incidents.

<artifact ArtifactUUID="26fdd1ba-603a-453d-ae91-41455f235e9a">Core Functionality and Data Flow</artifact>

The component manages:
- User input for incident details
- File attachments
- Location data
...
<document-code-reference section="State Management">
{"files": [
  {
    "name": "Campus-Shield/client/src/pages/ReportIncident.tsx",
    "description": "Implementation file",
...
This state object holds all user input and is updated throughout the form completion process.

## Form Steps

<document-code-reference section="Form Steps">
{"files": [
  {
    "name": "Campus-Shield/client/src/pages/ReportIncident.tsx",
    "description": "Implementation file",
...
The form is divided into three main steps:
1. Basic Information
2. Location Details
3. Attachments

Each step is conditionally rendered based on the `currentStep` state:
...
<artifact ArtifactUUID="4ffb1d03-b140-4869-b563-ffd2c43a3b36">Location Handling</artifact>

The component integrates with geolocation services to capture the user's current location:
...
<document-code-reference section="File Upload Handling">
{"files": [
  {
    "name": "Campus-Shield/client/src/pages/ReportIncident.tsx",
    "description": "Implementation file",
...
The component supports multiple file uploads with size and type restrictions:
...
<document-code-reference section="Form Submission">
{"files": [
  {
    "name": "Campus-Shield/client/src/pages/ReportIncident.tsx",
    "description": "Implementation file",
...
The `handleSubmit` function manages the form submission process:

1. Prevents default form submission
2. Sets loading state
3. Constructs FormData object with all report details
4. Sends a POST request to the server
...
<document-code-reference section="Integration with Backend">
{"files": [
  {
    "name": "Campus-Shield/client/src/pages/ReportIncident.tsx",
    "description": "Implementation file",
...
The component interacts with the server-side `/api/reports` endpoint, which is defined in `server/routes/reports.js`. This endpoint handles:

- Report creation in MongoDB or memory store
- AI processing for categorization and sentiment analysis
- File storage for attachments

The server-side model (`server/models/Report.js`) defines the structure for storing report data, including:

- Anonymous reporter identification
- Report content (title, description, category)
- Location data
- Incident timestamp
- File attachments
...
The component uses a combination of client-side validation and server response handling to provide user feedback:

- Input validation errors are displayed in real-time
- Submission errors are caught and displayed to the user
